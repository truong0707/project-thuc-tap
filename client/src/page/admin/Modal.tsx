...
export default function Modal(props: MyProps) {
    const setOpenModel = props.setOpenModel;

    const handleDeleteCourses = () => {
        const id = props.getIdCourses;
        axios.delete(`http://localhost:8080/api/v1/product-course/product_by_id?id=${id}`);
        setOpenModel(false)
    }
                            ...
                            <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                <div className="sm:flex sm:items-start">
                                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                        ...
                                        <h3 className="text-lg font-medium leading-6 text-gray-900" id="modal-title">Bạn có thật sự muốn xoá?</h3>
                                        <div className="mt-2">
                                            <p className="text-sm text-gray-500">Bạn có chắn chắn m uốn xoá khoá học này không? Dữ liệu sẽ bị xoá vĩnh viễn. Hành dộng này không thể được hoàn tác.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
